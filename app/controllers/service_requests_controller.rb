...
class ServiceRequestsController < ApplicationController
  ...
  def create
    ...
    if @service_request.save
      redirect_to customer_service_request_path(@service_request.customer, @service_request), notice: 'Service request was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @service_request.update(service_request_params)
      redirect_to customer_service_request_path(@service_request.customer, @service_request), notice: 'Service request was successfully updated.'
    else
      render :edit
    end
  end
