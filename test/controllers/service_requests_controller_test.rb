...
class ServiceRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_request" do
    assert_difference('ServiceRequest.count') do
      post service_requests_url, params: { service_request: { call_id: @service_request.call_id, customer_remark: @service_request.customer_remark, problem: @service_request.problem, status: @service_request.status } }
    end
  ...
  test "should update service_request" do
    patch service_request_url(@service_request), params: { service_request: { call_id: @service_request.call_id, customer_remark: @service_request.customer_remark, problem: @service_request.problem, status: @service_request.status } }
